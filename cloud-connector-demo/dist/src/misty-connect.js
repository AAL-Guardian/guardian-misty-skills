...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            data = {
                "token": "a2ee9fb7-270e-4dc9-96a5-b4fc1f5684e9",
                "clientId": "misty-123115431231",
                "endpoint": "a2tjpje3lbynp5-ats.iot.eu-west-1.amazonaws.com",
                "robotCode": "123115431231",
                "robotTopic": "misty-123115431231",
                "protocol": "wss",
            ...
            try {
                ...
                connection.on("message", function (topic, payload, packet) {
                    misty.DisplayText(topic);
                    var question = JSON.parse(payload.toString());
